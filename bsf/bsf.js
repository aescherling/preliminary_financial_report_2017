...
plotData = function(error, data, dataType) {
  ...
  // total funds in the background. draw the combined height; only (total - BSF) = reserve will show up.
  ...
  function drawValues() {
    ...
    graph.selectAll(".bsfBar")
      .transition()
      .duration(500)
      .attr("y", function(d) { return y(d.begin_bsf / 1e6); })
      .attr("height", function(d) { return graphHeight - y(d.begin_bsf / 1e6); });
  }
